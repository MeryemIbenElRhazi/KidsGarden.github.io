...
<div class="contaainer">
    ...
    <img src="etudiante.jpg" alt="Profile Picture" class="profile-pic">
        <h1 style="color:  #31999A;">Hello</h1>
         <span><?php echo $_SESSION['user_name'] ?></span>
         <div>
        <a href="cours1.html" class="btn">cours</span></a><br>
        <a href="exercices1.html" class="btn">Exercices</a><br>
        <a href="TPS1.html" class="btn">TPS</a><br>
        <a href="logout.php" class="btn">LogOut</a>
        </div>
        <br>
        <br>
        <span><a href="mailto:gardenkids@gmail.com"><i class='bx bxl-gmail' style="color:#31999A;"></i></a></span>
        <span><i class='bx bxs-phone bx-tada'  style="color:#31999A;"></i></span>
    </div>
    ...
    <div id="content22" >
    <div class="image3" >
            <img src="etudiant.png" style="max-width: 500px">
        </div>
    </div>

    <div id="content32" style="padding:20%;color:white;">
      <br><br><br>
